...
class Config:
    ...
    # 2048 is the largest context that stays 100% on this GPU: measured, 3072
    # puts 15% of the model on the CPU and 4096 puts 20%. Room for the memory
    # block comes out of history instead -- see max_history_turns.
    num_ctx: int = 2048
    ...
    vtube_map: dict = field(default_factory=lambda: {
        ...
        "smug": "cat_pos",      # cat mouth
        "thinking": "megane",   # glasses
    })
    ...
    vtube_motion_body: float = 2.0     # body lean, via FacePosition
    ...
    # Whether the head parameters point the opposite way to the eye ones. The
    # sign of FaceAngleX against EyeLeftX is a property of the rig and could not
    # be checked here without watching the model. If she turns her head *away*
    # from whatever she just glanced at, or her eyes swing wide instead of
    # settling after a glance, set this True. Run `--eyes` and watch: on a big
    # look the eyes should move first and the head should chase them.
    vtube_gaze_flip: bool = False
